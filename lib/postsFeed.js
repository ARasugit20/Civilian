...
// Default 7s write + ~2.5s geocode on POST stays under Vercel Hobby 10s function limit.
export const DB_WRITE_TIMEOUT_MS = Number(process.env.INSFORGE_WRITE_TIMEOUT_MS) || 7000;
